...
public abstract class ContenidorBrossa implements Comparable<ContenidorBrossa> {
    ...
    public void retirarViaPublica() throws ExceptionContenidorBrossa {
        if (ubicacio == null) {
            throw new ExceptionContenidorBrossa("El contenidor ja està al magatzem.");
        }
        any = 0;
        ubicacio = null;
    }

    public void retirarViaPublica(ContenidorBrossa[] a) throws ExceptionContenidorBrossa {
